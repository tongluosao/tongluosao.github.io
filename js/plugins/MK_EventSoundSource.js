 ...
 * @author Mikan 
 * @version v0.2.02 2020/04/25 解决读档回到同一地图导致配置错误的问题
 *   v0.2.01 2020/02/02 解决了停止时打开菜单会播放的问题
 *   v0.2.00 2020/02/02 允许设置初始声音不播放或不循环
 *   v0.1.05 2020/02/02 优化了音频的清理
 *   v0.1.04 2020/02/01 添加了获取音乐播放状态的功能
 *   v0.1.03 2020/02/01 解决了读档bug 添加了控制、更变音乐的功能
 *   v0.1.02 2020/01/31 可以为非自身事件设置音源
 *   v0.1.01 2020/01/31 完成了最初的构架
 * 
 * 
 * @help
 * ---- 插件指令 ----
