...
NoiseLine_Sprite.prototype.update = function() {
    Sprite.prototype.update.call(this);
	this.x = Math.min((Math.max((this.x+this._vector_x),0)),816);
...
NoiseDot_Sprite.prototype.update = function() {
    ...
    if (Math.floor(Math.random()*50) == 1){
      ...
      this.x = Math.floor(Math.random()*816);
...
Spriteset_Base.prototype.createNoisePlane = function() {
	 ...
	 this._NoisePlane.z = 51;
	 this._NoisePlane._zIndex = 3500;
	 this._NoisePlane.origin = new Point();
	     this._baseSprite.addChild(this._NoisePlane);
...
Spriteset_Base.prototype.updateNoisePlane = function() {
	...
	var _alias_lmd_weather_ex_sprtbase_createToneChanger = Spriteset_Base.prototype.createToneChanger;
Spriteset_Base.prototype.createToneChanger = function() {
    _alias_lmd_weather_ex_sprtbase_createToneChanger.call(this);
...
Spriteset_Base.prototype.update = function() {
	 ...
	 if(($gameSwitches.value('10') == true)){
		 if(this._base_sprite1==null || this._line_sprites1==null || this._line_sprites1==null || this._line_sprites2==null || this._line_sprites3==null || this._line_sprites4==null ||this._dot_sprite==null){
			this.createNoisePlane(); 
		 }else{
